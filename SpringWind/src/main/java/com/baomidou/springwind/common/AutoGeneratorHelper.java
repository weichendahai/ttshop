...
public class AutoGeneratorHelper {
	...
	public static void main(String[] args) {
		...
		if (EnvUtil.isLinux()) {
			gc.setOutputDir("D:/ShengCheng/Linux/springwind/");
		} else {
			gc.setOutputDir("D:/ShengCheng/springwind/");
		}
		...
		dsc.setUsername("ssm");
		dsc.setPassword("Ssm0308!");
		dsc.setUrl("jdbc:mysql://192.168.1.222:3306/ssmdb?characterEncoding=utf8");
