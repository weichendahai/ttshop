...
public class PoShopUserRefundFeedback extends Model<PoShopUserRefundFeedback> {
	...
	private ShopUserRefund shopUserRefund;

	public ShopUserRefund getShopUserRefund() {
		return shopUserRefund;
	}

	public void setShopUserRefund(ShopUserRefund shopUserRefund) {
		this.shopUserRefund = shopUserRefund;
	}
