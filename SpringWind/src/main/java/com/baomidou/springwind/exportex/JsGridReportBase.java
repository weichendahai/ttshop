 ...
 * 修改内容：
 */
package com.baomidou.springwind.exportex;
...
public class JsGridReportBase {
	...
	private static String MODULE_PATH = "../views/order/module.xls";//模板路径
	...
	public void exportToExcel(String title, String creator, List<TableData> tableDataLst)
		...
		String sFileName = title + ".xls";
		response.setHeader("Content-Disposition", "attachment;filename="+new String (sFileName.getBytes("GB2312"), "ISO-8859-1"));
		response.setHeader("Connection", "close");
		response.setHeader("Content-Type", "application/vnd.ms-excel");
